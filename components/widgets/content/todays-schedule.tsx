...
const EVENTS = [
  { time: '9:00',  title: 'Team standup',  short: 'Standup',  color: '#3b82f6', duration: '30m' },
  { time: '10:00', title: 'Deep work',     short: 'Deep work', color: '#8b5cf6', duration: '90m' },
  { time: '11:30', title: 'Design review', short: 'Design review', color: '#ec4899', duration: '45m' },
  { time: '12:30', title: 'Lunch',         short: 'Lunch',    color: '#10b981', duration: '60m' },
];
...
function Timeline({ count, variant, duration, useShort }:
  { count: number; variant?: 'row' | 'stack'; duration?: boolean; useShort?: boolean }) {
  return (
